...
target_user = User.find_by_email "target@gmail.com"
...
response = HTTParty.post( "#{BASE_URL}/api2/comments" ,{
    :query => {
    ...
    :body => {
      :comment => {  
        :reimburse_detail_id => @reimburse_detail_1.id, 
         :content => "This is the comment conent",
